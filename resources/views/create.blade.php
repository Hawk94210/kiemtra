      ...
      <div class="row container">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" name="phone" class="form-control" style="width: 80%">
            @error('phone')
                <p class="text text-danger">{{ $message }}</p>
            @enderror
          </div>
          <div class="form-group">
            ...
            <input type="text" name="CMND" class="form-control" style="width: 80%">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <textarea name="address" id="" cols="55" rows="3"></textarea>
            @error('address')
                <p class="text text-danger">{{ $message }}</p>
            @enderror
          </div>
